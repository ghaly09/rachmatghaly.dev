    ...
    <Card className="flex flex-col w-[260px] justify-between font-ghaly rounded-[6px] border-gray-300 dark:border-gray-500 dark:bg-[#0e1111] hover:scale-[1.02] hover:duration-300 animate-shadow hover:shadow-lg">
      <Reveal delay={0.05} duration={0.8}>
        <CardHeader>
          ...
          <CardDescription className="w-auto bg-gradient-to-r from-[rgb(146,245,242)] dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-[rgb(0,218,210)] dark:to-[rgb(61,224,102)]">
            {description}
          </CardDescription>
        </CardHeader>
      </Reveal>
